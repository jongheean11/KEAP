...
namespace Fizbin.Kinect.Gestures.Segments
{
    ...
    /// </summary>
    public class LeftUpsegments1: IRelativeGestureSegment
    {
        /// <summary>
        /// Checks the gesture.
        /// </summary>
        ...
        public Dictionary<GesturePartResult, float> CheckGesture(Skeleton skeleton,bool leftHandGrip,bool rightHandGrip)
        {
            ...
            if (skeleton.Joints[JointType.HandLeft].Position.Z < skeleton.Joints[JointType.ShoulderLeft].Position.Z - 0.3 && rightHandGrip == true)
            {
                ...
                //방향
                        ...
                        Convert.ToDouble(skeleton.Joints[JointType.ShoulderLeft].Position.X - skeleton.Joints[JointType.HandLeft].Position.X)) < 0.98 && 
                        ...
                        Convert.ToDouble(skeleton.Joints[JointType.ShoulderLeft].Position.X - skeleton.Joints[JointType.HandLeft].Position.X)) > 0.58                            
                        )
                        {
